...
- Hardened macOS image lifecycle smoke so source, candidate, and promoted images must expose macOS 15+, a selected full Xcode developer directory, and Swift tools 6.2+ before promotion.
